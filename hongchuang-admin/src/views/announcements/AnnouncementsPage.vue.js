...
import { createAnnouncementApi, deleteAnnouncementApi, getAnnouncementListApi, updateAnnouncementApi } from '@/api/announcements';
...
const pinnedSwitch = computed({ get: () => form.isPinned === 1, set: (value) => { form.isPinned = value ? 1 : 0; } });
const resetForm = () => {
...
__VLS_30.slots.default;
{
    ...
    const __VLS_32 = __VLS_asFunctionalComponent(__VLS_31, new __VLS_31({
        type: (row.publishStatus === 2 ? 'success' : 'info'),
    }));
    const __VLS_33 = __VLS_32({
        type: (row.publishStatus === 2 ? 'success' : 'info'),
    }, ...__VLS_functionalComponentArgsRest(__VLS_32));
    __VLS_34.slots.default;
    (row.publishStatus === 2 ? '已发布' : '草稿');
    var __VLS_34;
}
var __VLS_30;
...
const __VLS_72 = __VLS_asFunctionalComponent(__VLS_71, new __VLS_71({
    ...
    title: (__VLS_ctx.editingId ? '编辑公告' : '发布公告'),
    width: "620px",
}));
...
//# sourceMappingURL=AnnouncementsPage.vue.js.map