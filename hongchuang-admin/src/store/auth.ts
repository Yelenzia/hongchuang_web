...
import { adminLoginApi, adminLogoutApi, adminMeApi, type AdminLoginRequest, type AdminUserInfo } from '@/api/auth'
...
export const useAdminAuthStore = defineStore('adminAuth', {
  state: (): AdminAuthState => ({
    ...
    userInfo: JSON.parse(localStorage.getItem('hc_admin_user_info') || 'null') as AdminUserInfo | null,
    initialized: false
  }),
  getters: {
  ...
  actions: {
    setAuth(token: string, userInfo: AdminUserInfo) {
